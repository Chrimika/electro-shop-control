        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/stores" className="text-gray-600 hover:text-blue-600">
                Boutiques
              </Link>
              <Link to="/sales" className="text-gray-600 hover:text-blue-600">
                Ventes
              </Link>
                ...
                <Button variant="ghost" className="p-0">
                  <div className="flex items-center gap-2">
                    <Avatar className="h-8 w-8">
                      <AvatarFallback>{currentUser.displayName ? getInitials(currentUser.displayName) : 'OU'}</AvatarFallback>
                    </Avatar>
                    <span className="hidden md:inline">{currentUser.displayName || 'Utilisateur'}</span>
